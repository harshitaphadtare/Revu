...
export function HomePage({ onAnalyze }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/20 flex flex-col">
      ...
      {/* Header */}
      <header className="relative z-50 bg-background/60 backdrop-blur-xl border-b border-border/50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            <span className="text-2xl tracking-wider" style={{ fontFamily: "Lexend, sans-serif", fontWeight: 700 }}>
              REVU
            </span>
          </motion.div>
          ...
          >
            ...
            >
              ...
              >
                <Button className="relative overflow-hidden rounded-full px-6 shadow-lg hover:shadow-2xl transition-all duration-300 group cursor-pointer">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/50 backdrop-blur-sm border border-border/50 mb-6 cursor-default"
              >
                <motion.div
                  animate={{ 
                    scale: [1, 1.2, 1],
                ...
                />
                <span className="text-sm text-muted-foreground">AI-Powered Review Analysis</span>
              </motion.div>
            ...
            >
              ...
              >
                <motion.div
                  ...
                  className="absolute -inset-1 bg-gradient-to-r from-purple-500 via-blue-500 to-teal-500 rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-500"
                />
                <div className="relative bg-card rounded-2xl shadow-2xl border border-border/50 overflow-hidden backdrop-blur-xl">
                  <input
                    type="url"
                    value={url}
              ...
              >
                ...
                >
                  ...
                  <Button
                    ...
                    className="relative overflow-hidden px-10 py-6 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white border-0 shadow-xl transition-all duration-300 disabled:opacity-90 cursor-pointer"
                  >
                    {/* Ripple effects */}
                    <AnimatePresence>
                      {ripples.map((ripple) => (
