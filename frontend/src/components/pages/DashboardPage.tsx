...
export function DashboardPage({ onReset, onThemeToggle, onProfileClick, isDark }: DashboardPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-black">
      {/* Navigation Bar */}
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-border/50 dark:border-zinc-800/50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            <span 
              className="text-2xl tracking-wider text-foreground dark:text-white" 
          ...
          >
            ...
            <Button 
              variant="outline" 
              size="icon" 
              className="rounded-full w-10 h-10 border-border dark:border-zinc-700"
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        >
          ...
          <motion.footer
            ...
            className="pt-8 pb-6 border-t border-border dark:border-zinc-800"
          >
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <span className="text-muted-foreground dark:text-gray-400">Engineered by </span>
                <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Harshita Phadtare</span>
              </div>
              <a 
                href="https://github.com" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-muted-foreground dark:text-gray-400 hover:text-foreground dark:hover:text-white transition-colors group"
              >
